...
# Define a 5x5 keair.pyrnel for erosion and dilation
...
#paintWindow = cv2.imread('board.jpg')
...
while True:
    ...
    k = cv2.waitKey(50)
    if k == ord("s"):
        cv2.imwrite('new_image.png', paintWindow)
        # converting image to pdf format
        # img_path= " new_image.png "
        # img_path="E:/Project/Machine Learning/Muthu(Python)/PY1019/Project/new_image.png"
        # pdf_path="E:/Project/Machine Learning/Muthu(Python)/PY1019/Project/new_pdf.pdf"
        ...
        with open("new_file.pdf", "wb") as f:
            f.write(img2pdf.convert("new_image.png"))
...
# Cleanup the camera and close any pen windows
camera.release()
